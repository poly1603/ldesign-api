 ...
 * ***********************************
 */
import { systemApiPlugin } from '../plugins/systemApi.js';
import { ApiEngineImpl } from './ApiEngine.js';
...
function createApiEngineByEnv(baseURL, options = {}) {
  ...
  const viteEnv = typeof import.meta !== "undefined" ? import.meta.env : void 0;
...
export { createApiEngine, createApiEngineByEnv, createApiEngineWithDefaults, createApiEngineWithPlugins, createDevelopmentApiEngine, createProductionApiEngine, createSingletonApiEngine, createSystemApiEngine, createSystemApiEngineByEnv, createTestApiEngine, destroySingletonApiEngine };
