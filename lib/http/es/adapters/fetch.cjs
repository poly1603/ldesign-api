...
class n extends base.BaseAdapter {
  constructor() {
  ...
  buildHeaders(s2) {
    const a2 = { ...s2.headers };
    return s2.data && !a2["content-type"] && !a2["Content-Type"] && ("string" == typeof s2.data ? a2["Content-Type"] = "text/plain" : index.isFormData(s2.data) ? delete a2["Content-Type"] : index.isURLSearchParams(s2.data) ? a2["Content-Type"] = "application/x-www-form-urlencoded" : "object" == typeof s2.data && (a2["Content-Type"] = "application/json")), a2;
  }
  buildBody(r2, n2) {
    if (null != r2) {
      if ("string" == typeof r2 || index.isFormData(r2) || index.isBlob(r2) || index.isArrayBuffer(r2) || index.isURLSearchParams(r2) || r2 instanceof ReadableStream) return r2;
