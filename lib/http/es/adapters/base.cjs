...
let t$1 = class t {
  processConfig(r2) {
    const t2 = { ...r2 };
    return t2.url && (t2.url = index.buildURL(t2.url, t2.baseURL, t2.params)), t2.method || (t2.method = "GET"), t2.headers || (t2.headers = {}), t2;
  }
  ...
  processError(e2, t2, o) {
    ...
    const a = index.createHttpError(n, t2, s, o);
