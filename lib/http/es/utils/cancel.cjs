...
class t {
  ...
  throwIfRequested() {
    if (this.isCancelled) throw error.ErrorHandler.createCancelError({});
  }
}
class a {
  constructor() {
...
exports.CancelManager = s;
exports.CancelTokenImpl = t;
exports.CancelTokenSource = a;
exports.EnhancedCancelManager = n;
exports.createCancelTokenSource = r;
exports.globalCancelManager = c;
