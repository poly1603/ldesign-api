 ...
 * RESTful API 定义
 */
export interface RestfulApiDefinition<TParams = unknown, TResponse = unknown> extends ApiDefinition<TParams, TResponse> {
    type: 'restful';
    /** 请求路径 */
    path: string;
    /** HTTP 方法 */
 ...
 * LEAP API 定义
 */
export interface LeapApiDefinition<TParams = unknown, TResponse = unknown> extends ApiDefinition<TParams, TResponse> {
    type: 'leap';
    /** LEAP 方法名 */
    method: string;
    /** 服务名称（覆盖服务器默认值） */
 ...
 * 统一 API 定义类型
 */
export type UnifiedApiDefinition<TParams = unknown, TResponse = unknown> = RestfulApiDefinition<TParams, TResponse> | LeapApiDefinition<TParams, TResponse>;
/**
 * RESTful 请求选项
 */
...
export interface ApiAdapter {
    ...
    /** 执行请求 */
    execute<TResponse = unknown>(api: UnifiedApiDefinition, options: ApiRequestOptions, httpClient: HttpClient, serverConfig: ServerConfig): Promise<ApiResult<TResponse>>;
}
/**
 * 代理配置
 */
 ...
 */
export declare function isRestfulApi(api: UnifiedApiDefinition): api is RestfulApiDefinition;
/**
 * 判断是否为 LEAP API 定义
 */
export declare function isLeapApi(api: UnifiedApiDefinition): api is LeapApiDefinition;
/**
 * 判断是否为 API 错误
 */
 ...
 * 创建 API 错误
 */
export declare function createApiError(message: string, options?: Partial<ApiError>): ApiError;
